...
- runbook: `docs/developer/runbooks/pre-pilot-governed-flow-runbook.md`
- expected outputs guide: `docs/developer/runbooks/pre-pilot-expected-outputs.md`
- readiness checklist: `docs/developer/checklists/pre-pilot-readiness-checklist.md`
