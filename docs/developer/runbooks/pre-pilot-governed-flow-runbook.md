...
```bash
rg -n "workspace_governed_vertical_slice_v1" tests/integration/workspace_lifecycle/workspace_final_demo_matrix_v1.sh docs/architecture/final-governed-workspace-demo-matrix.md Makefile
```
