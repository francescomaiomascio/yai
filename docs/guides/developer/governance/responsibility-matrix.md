...
| `sdk` | public programmatic surface consumer | no structural cross-repo pin | pinning `governance`, pinning `cli` | non-authoritative for governance | declares supported compatibility | may consume exported/generated governance artifacts (optional) | must not be registry/governance-live coupled |
