...
See `deps/yai-specs/specs/protocol/transport.h` for schema details.
...
See `deps/yai-specs/specs/control/control_plane.v1.json`.
...
See `deps/yai-specs/specs/providers/PROVIDERS_TRUST.md`.
