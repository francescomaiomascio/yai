...
- Updated architecture docs to C entrypoints:
  - docs/archive/historical-architecture/platform/architecture/components/mind-overview.md
  - docs/archive/historical-architecture/platform/architecture/components/mind.md
