...
|---|---|---|---|
| Storage classes defined | confirmed | `docs/program/milestone-packs/runtime-baselines/mp-runtime-000-data-plane-storage-classes.md` | Baseline complete. |
| Backend role model defined | confirmed | `docs/program/milestone-packs/runtime-baselines/mp-runtime-000-data-plane-storage-classes.md` | Role fit defined; backend final choices still selective. |
| Canonical topology defined | confirmed | `docs/program/milestone-packs/runtime-baselines/mp-runtime-000-data-plane-storage-topology.md` | Single-node topology baseline. |
| Non-bypass rules declared | confirmed | `docs/program/milestone-packs/runtime-baselines/mp-runtime-000-data-plane.md` | Enforced through runtime contract path. |
...
| No backend leakage in canonical contract | confirmed | `docs/program/milestone-packs/runtime-baselines/mp-runtime-000-data-surfaces-and-operator-query-architecture.md` | Backend roles remain internal detail. |
