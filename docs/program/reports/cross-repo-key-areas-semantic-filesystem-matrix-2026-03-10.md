...
|---|---|---|---|
| Policy engine (normative + execution) | Define policy semantics and execute deterministic resolution/effects | `law` + `yai` (+ surfaced by `sdk`/`cli`) | `../law/manifests/`, `../law/grammar/`, `../law/registry/`, `../law/schema/`, `../law/control-families/`, `../law/domain-specializations/`, `../law/overlays/`; `lib/law/`, `include/yai/law/`, `embedded/law/`, `tests/unit/law/`, `tests/integration/law_resolution/` |
