...
related:
  ...
  - ../law/docs/program/23-runbooks/law-topology-realign-against-unified-runtime.md
...
Operational evidence and manual validation commands are maintained under `docs/program/audit-convergence/`.
