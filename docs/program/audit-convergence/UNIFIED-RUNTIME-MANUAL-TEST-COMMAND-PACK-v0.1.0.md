...
```bash
cd /Users/francescomaiomascio/Developer/YAI/yai && make yai -j4 && tests/integration/workspace_lifecycle/workspace_runtime_contract_v1.sh && tests/integration/workspace_lifecycle/workspace_graph_read_surfaces_dp16_v1.sh
