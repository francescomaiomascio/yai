...
related:
  ...
  - docs/program/audit-convergence/UNIFIED-RUNTIME-CLOSEOUT-INDEX-v0.1.0.md
  - docs/program/audit-convergence/UNIFIED-RUNTIME-ECOSYSTEM-VERIFICATION-MATRIX-v0.1.0.md
  - docs/program/audit-convergence/UNIFIED-RUNTIME-MANUAL-TEST-COMMAND-PACK-v0.1.0.md
...
- Unified runtime closeout index (single entrypoint): `docs/program/audit-convergence/UNIFIED-RUNTIME-CLOSEOUT-INDEX-v0.1.0.md`
- Unified runtime closeout matrix: `docs/program/audit-convergence/UNIFIED-RUNTIME-ECOSYSTEM-VERIFICATION-MATRIX-v0.1.0.md`
- Unified runtime manual command pack: `docs/program/audit-convergence/UNIFIED-RUNTIME-MANUAL-TEST-COMMAND-PACK-v0.1.0.md`
- Workspace verticalization matrix: `docs/program/audit-convergence/WORKSPACE-VERTICALIZATION-ECOSYSTEM-VERIFICATION-MATRIX-v0.1.0.md`
- Workspace verticalization manual command pack: `docs/program/audit-convergence/WORKSPACE-VERTICALIZATION-MANUAL-TEST-COMMAND-PACK-v0.1.0.md`
- WS command verticalization report: `docs/program/audit-convergence/WS-COMMAND-VERTICALIZATION-REPORT-v0.1.0.md`
...
- Full command registry inventory export (TSV): `docs/program/audit-convergence/WS-COMMAND-REGISTRY-INVENTORY-v0.1.0.tsv`
