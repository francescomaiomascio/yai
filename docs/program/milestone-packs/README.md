...
- `docs/program/milestone-packs/contract-baseline-lock/README.md`

## Current track: Workspaces lifecycle

- `docs/program/milestone-packs/workspaces-lifecycle/README.md`

## Current track: Command coverage (non-WS)

- `docs/program/milestone-packs/command-coverage/README.md`

## Planned track: Engine attach

- `docs/program/milestone-packs/engine-attach/README.md`

## Planned track: Specs refactor foundation

- `docs/program/milestone-packs/specs-refactor-foundation/README.md`
...
- `docs/program/templates/milestone-packs/MP-000-template.md`
