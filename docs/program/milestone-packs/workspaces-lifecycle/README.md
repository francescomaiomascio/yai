...
status: active
runbook: docs/program/milestone-packs/runtime-baselines/mp-runtime-000-mp-runtime-000-workspaces-lifecycle.md
phase: index
adrs:
...
- `docs/program/milestone-packs/workspaces-lifecycle/mp-workspace-000-workspaces-lifecycle-v0-1-0.md`
- `docs/program/milestone-packs/workspaces-lifecycle/mp-workspace-000-workspaces-lifecycle-v0-1-1.md`
- `docs/program/milestone-packs/workspaces-lifecycle/mp-workspace-000-workspaces-lifecycle-v0-1-2.md`
- `docs/program/milestone-packs/workspaces-lifecycle/mp-workspace-000-workspaces-lifecycle-v0-1-3.md`
- `docs/program/milestone-packs/workspaces-lifecycle/mp-workspace-000-workspaces-lifecycle-v0-1-4.md`
