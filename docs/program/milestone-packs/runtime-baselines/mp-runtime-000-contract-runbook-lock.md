...
## 1) Purpose
Create the first governance runbook that locks cross-repo contract behavior across `law`, `yai`, and `cli` before any additional hardening tracks.

## 2) Preconditions
- [x] `docs/program/adr/adr-contracts-011-contract-runbook-lock.md` is present and traceable.
- [x] Cross-repo repositories are reachable (`law`, `yai`, `cli`).
- [x] Contract edits are performed in source repo (`law`) and only pinned in consumers.
...
2. Specs refactor foundation (`docs/program/milestone-packs/runtime-baselines/mp-runtime-000-specs-refactor-foundation.md`).
3. Root hardening (`docs/program/milestone-packs/runtime-baselines/mp-runtime-000-root-hardening.md`).
...
Claim: `yai` and `cli` consume the same audited `law` baseline.
- Scope: pin update + lock verification only.
- Gate: pin checks green and reproducible.
- Milestone Pack (planned): `docs/program/milestone-packs/contract-baseline-lock/mp-contracts-000-contract-runbook-lock-v0-1-0.md`
...
- Milestone Pack: `docs/program/milestone-packs/contract-baseline-lock/mp-contracts-000-contract-runbook-lock-v0-1-1.md`
...
- Milestone Pack: `docs/program/milestone-packs/contract-baseline-lock/mp-contracts-000-contract-runbook-lock-v0-1-2.md`
...
- Milestone Pack: `docs/program/milestone-packs/contract-baseline-lock/mp-contracts-000-contract-runbook-lock-v0-1-3.md`
...
- Milestone Pack: `docs/program/milestone-packs/contract-baseline-lock/mp-contracts-000-contract-runbook-lock-v0-1-4.md`
...
- Next runbook: `docs/program/milestone-packs/runtime-baselines/mp-runtime-000-specs-refactor-foundation.md`
- MP track: `docs/program/milestone-packs/contract-baseline-lock/README.md`
...
- MPs (filled as phases ship):
  - `docs/program/milestone-packs/contract-baseline-lock/mp-contracts-000-contract-runbook-lock-v0-1-0.md`
  - `docs/program/milestone-packs/contract-baseline-lock/mp-contracts-000-contract-runbook-lock-v0-1-1.md`
  - `docs/program/milestone-packs/contract-baseline-lock/mp-contracts-000-contract-runbook-lock-v0-1-2.md`
  - `docs/program/milestone-packs/contract-baseline-lock/mp-contracts-000-contract-runbook-lock-v0-1-3.md`
  - `docs/program/milestone-packs/contract-baseline-lock/mp-contracts-000-contract-runbook-lock-v0-1-4.md`
...
- `docs/program/milestone-packs/runtime-baselines/mp-runtime-000-specs-refactor-foundation.md`
