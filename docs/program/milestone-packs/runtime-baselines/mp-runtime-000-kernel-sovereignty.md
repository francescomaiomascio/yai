...
## 8) References
- ADR: `docs/program/adr/adr-runtime-003-kernel-authority.md`
- Runbooks: `docs/program/milestone-packs/runtime-baselines/mp-runtime-000-root-hardening.md`, `docs/program/milestone-packs/runtime-baselines/mp-runtime-000-engine-attach.md`
...
**A) Spec:** `../law/formal/YAI_KERNEL.tla`
...
**B) Config:** `../law/formal/YAI_KERNEL.cfg`
...
/* Workspace id validate (ideally use the inline in ../law/contracts/protocol/include/transport.h) */
...
4. Document security model in `docs/program/policies/security/SOVEREIGNTY.md`
