...
- Customer-grade remote owner/peer operation requires secure peering baseline per
  `docs/program/milestone-packs/runtime-baselines/mp-runtime-000-secure-peering-deployment-runbook.md`.
...
- YD-1 topology lock and naming baseline are documented in
  `docs/program/milestone-packs/runtime-baselines/mp-runtime-000-daemon-architecture-runbook.md`.
...
- RF-0.2 policy hierarchy lock baseline:
  `docs/program/milestone-packs/runtime-baselines/mp-runtime-000-global-to-edge-policy-hierarchy-runbook.md`.
- RF-0.3 delegated edge enforcement baseline:
  `docs/program/milestone-packs/runtime-baselines/mp-runtime-000-delegated-edge-enforcement-runbook.md`.
- RF-0.4 process and asset runtime observation baseline:
  `docs/program/milestone-packs/runtime-baselines/mp-runtime-000-process-and-asset-runtime-observation-runbook.md`.
- ER-2 edge state/spool/retry/health baseline:
  `docs/program/milestone-packs/runtime-baselines/mp-runtime-000-edge-state-spool-retry-health-runbook.md`.
