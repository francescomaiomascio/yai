...
- `docs/program/milestone-packs/runtime-baselines/mp-runtime-000-enforcement-to-record-persistence.md`

Priority order:
1. close enforcement -> canonical persisted record set writers
2. materialize graph from typed refs (`docs/program/milestone-packs/runtime-baselines/mp-runtime-000-graph-materialization-from-runtime-records.md`)
3. cut readers to DB-first canonical sources (`docs/program/milestone-packs/runtime-baselines/mp-runtime-000-db-first-read-path-cutover.md`).
4. map filesystem operational residues (`docs/program/milestone-packs/runtime-baselines/mp-runtime-000-filesystem-governance-state-decommission.md`).
5. execute cleanup/archive of decommissioned residues (`docs/program/milestone-packs/runtime-baselines/mp-runtime-000-filesystem-cleanup-and-archive-execution.md`).
6. strengthen DB-backed governance/compliance visibility.
7. define lifecycle/retention/tiering model (`docs/program/milestone-packs/runtime-baselines/mp-runtime-000-data-lifecycle-retention-and-tiering.md`).
...
- `docs/program/milestone-packs/runtime-baselines/mp-runtime-000-data-plane-storage-classes.md`
- `docs/program/milestone-packs/runtime-baselines/mp-runtime-000-data-plane-storage-topology.md`
- `docs/program/milestone-packs/runtime-baselines/mp-runtime-000-workspace-data-sinks.md`
...
- `docs/program/milestone-packs/runtime-baselines/mp-runtime-000-brain-memory-and-graph-sinks.md` (historical alias note)
...
- `docs/program/milestone-packs/runtime-baselines/mp-runtime-000-enforcement-to-record-persistence.md`
- `docs/program/milestone-packs/runtime-baselines/mp-runtime-000-graph-materialization-from-runtime-records.md`
- `docs/program/milestone-packs/runtime-baselines/mp-runtime-000-db-first-read-path-cutover.md`
- `docs/program/milestone-packs/runtime-baselines/mp-runtime-000-filesystem-governance-state-decommission.md`
- `docs/program/milestone-packs/runtime-baselines/mp-runtime-000-filesystem-cleanup-and-archive-execution.md`
- `docs/program/milestone-packs/runtime-baselines/mp-runtime-000-data-lifecycle-retention-and-tiering.md`
