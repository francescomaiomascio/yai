...
**Milestone Pack:** `docs/program/milestone-packs/root-hardening/mp-runtime-000-root-hardening-v0-1-0.md`
...
**Milestone Pack:** `docs/program/milestone-packs/root-hardening/mp-runtime-000-root-hardening-v0-1-1.md`
**Claim IDs:** `C-ENVELOPE-HANDSHAKE-REQUIRED`, `C-DOMAIN-COVERAGE-NETWORK`
**Mandatory evidence commands:**
- `tools/bin/yai-verify`
- `tools/bin/yai-suite`
...
**Milestone Pack:** `docs/program/milestone-packs/root-hardening/mp-runtime-000-root-hardening-v0-1-2.md`
...
**Milestone Pack:** `docs/program/milestone-packs/root-hardening/mp-runtime-000-root-hardening-v0-1-3.md`
...
**Milestone Pack:** `docs/program/milestone-packs/root-hardening/mp-runtime-000-root-hardening-v0-1-4.md`
...
**Milestone Pack:** `docs/program/milestone-packs/root-hardening/mp-runtime-000-root-hardening-v0-1-5.md`
...
- `docs/program/milestone-packs/root-hardening/README.md` (`MP-ROOT-HARDENING-INDEX`)
