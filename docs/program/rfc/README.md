...
|---|---|---|---|
| PRP-001 | `RFC-001-runtime-topology-and-authority.md` | `docs/program/adr/ADR-001-single-runtime.md` | draft |
| PRP-002 | `RFC-002-unified-rpc-and-cli-contract.md` | `docs/program/adr/ADR-006-unified-rpc.md` | draft |
| PRP-003 | `RFC-003-workspace-lifecycle-and-isolation.md` | `docs/program/adr/ADR-007-workspace-isolation.md` | draft |
| PRP-004 | `RFC-004-contract-baseline-lock-and-pin-policy.md` | `docs/program/adr/ADR-011-contract-baseline-lock.md` | draft |
