...
- `yai-law` (WSV-3): registry canonicalization (`commands.v1.json` and linked surfaces).
...
- WSV-3 can align law registry command truth to canonical CLI grammar.
