...
- YD-1 topology lock and naming baseline are documented in
  `docs/runbooks/operations/program/daemon-architecture-refoundation-baseline.md`.
...
- RF-0.2 policy hierarchy lock baseline:
  `docs/runbooks/operations/program/global-to-edge-policy-hierarchy-baseline.md`.
- RF-0.3 delegated edge enforcement baseline:
  `docs/runbooks/operations/program/delegated-edge-enforcement-baseline.md`.
- RF-0.4 process and asset runtime observation baseline:
  `docs/runbooks/operations/program/process-and-asset-runtime-observation-baseline.md`.
- ER-2 edge state/spool/retry/health baseline:
  `docs/runbooks/operations/program/edge-state-spool-retry-health-baseline.md`.
