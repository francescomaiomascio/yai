...
## 8) References
- ADR: `docs/program/adr/ADR-005-mind-proposer.md`
- Runbooks: `docs/runbooks/operations/program/engine-attach.md`, `docs/runbooks/operations/program/data-plane.md`
