...
## 2) Preconditions
- [x] `docs/program/adr/ADR-011-contract-baseline-lock.md` is present and traceable.
...
2. Specs refactor foundation (`docs/runbooks/operations/program/specs-refactor-foundation.md`).
3. Root hardening (`docs/runbooks/operations/program/root-hardening.md`).
...
- Milestone Pack (planned): `docs/program/milestone-packs/contract-baseline-lock/MP-CONTRACT-BASELINE-LOCK-0.1.0.md`
...
- Milestone Pack: `docs/program/milestone-packs/contract-baseline-lock/MP-CONTRACT-BASELINE-LOCK-0.1.1.md`
...
- Milestone Pack: `docs/program/milestone-packs/contract-baseline-lock/MP-CONTRACT-BASELINE-LOCK-0.1.2.md`
...
- Milestone Pack: `docs/program/milestone-packs/contract-baseline-lock/MP-CONTRACT-BASELINE-LOCK-0.1.3.md`
...
- Milestone Pack: `docs/program/milestone-packs/contract-baseline-lock/MP-CONTRACT-BASELINE-LOCK-0.1.4.md`
...
- Next runbook: `docs/runbooks/operations/program/specs-refactor-foundation.md`
...
- MPs (filled as phases ship):
  ...
  - `docs/program/milestone-packs/contract-baseline-lock/MP-CONTRACT-BASELINE-LOCK-0.1.1.md`
  - `docs/program/milestone-packs/contract-baseline-lock/MP-CONTRACT-BASELINE-LOCK-0.1.2.md`
  - `docs/program/milestone-packs/contract-baseline-lock/MP-CONTRACT-BASELINE-LOCK-0.1.3.md`
  - `docs/program/milestone-packs/contract-baseline-lock/MP-CONTRACT-BASELINE-LOCK-0.1.4.md`
