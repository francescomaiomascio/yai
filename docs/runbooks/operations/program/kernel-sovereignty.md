...
## 8) References
- ADR: `docs/program/adr/ADR-003-kernel-authority.md`
- Runbooks: `docs/runbooks/operations/program/root-hardening.md`, `docs/runbooks/operations/program/engine-attach.md`
