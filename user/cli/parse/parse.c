...
static const char* map_operator_capability_command_id(const char* entrypoint, const char* topic)
{
  ...
  if (strcmp(entrypoint, "doctor") == 0) {
    ...
    if (strcmp(normalized_topic, "workspace") == 0) return "yai.operator.doctor.workspace";
  ...
  if (strcmp(entrypoint, "inspect") == 0) {
    if (strcmp(normalized_topic, "workspace") == 0) return "yai.operator.inspect.workspace";
    ...
    if (strcmp(normalized_topic, "mesh") == 0) return "yai.workspace.graph.workspace";
    if (strcmp(normalized_topic, "grant") == 0) return "yai.workspace.policy_effective";
    ...
    if (strcmp(normalized_topic, "case") == 0) return "yai.workspace.graph.summary";
    return NULL;
  }
  ...
  if (strcmp(entrypoint, "verify") == 0) {
    ...
    if (strcmp(normalized_topic, "workspace") == 0) return "yai.operator.verify.workspace";
...
int yai_porcelain_parse_argv(int argc, char** argv, yai_porcelain_request_t* req) {
  ...
  /* Canonical workspace command topology:
     - yai ws create|open|set|switch|current|status|inspect|unset|clear|reset|destroy
     - yai ws graph <summary|workspace|governance|decision|evidence|authority|artifact|lineage|recent>
     ...
     - yai ws knowledge <status|transient|memory|providers|context>
  ...
  if (strcmp(argv[cmdi], "ws") == 0) {
    if (cmdi + 1 >= argc || !argv[cmdi + 1]) {
      return set_err(req, "missing workspace action", "Run: yai help ws");
    }
    if (strcmp(argv[cmdi + 1], "create") == 0 ||
      ...
      if (cmdi + 2 >= argc || !argv[cmdi + 2] || !argv[cmdi + 2][0]) {
        return set_err(req, "missing workspace id", "Run: yai ws create <ws-id>");
      }
      req->kind = YAI_PORCELAIN_KIND_COMMAND;
      if (strcmp(argv[cmdi + 1], "create") == 0) req->command_id = "yai.workspace.create";
      else if (strcmp(argv[cmdi + 1], "reset") == 0) req->command_id = "yai.workspace.reset";
      else req->command_id = "yai.workspace.destroy";
      req->cmd_argc = argc - (cmdi + 2);
      req->cmd_argv = &argv[cmdi + 2];
      return 0;
    }
    if (strcmp(argv[cmdi + 1], "open") == 0) {
      if (cmdi + 2 >= argc || !argv[cmdi + 2] || !argv[cmdi + 2][0]) {
        return set_err(req, "missing workspace id", "Run: yai ws open <ws-id>");
      }
      req->kind = YAI_PORCELAIN_KIND_COMMAND;
      req->command_id = "yai.workspace.open";
      req->cmd_argc = argc - (cmdi + 2);
      req->cmd_argv = &argv[cmdi + 2];
      return 0;
    }
    if (strcmp(argv[cmdi + 1], "set") == 0) {
      if (cmdi + 2 >= argc || !argv[cmdi + 2] || !argv[cmdi + 2][0]) {
        return set_err(req, "missing workspace id", "Run: yai ws set <ws-id>");
      }
      req->kind = YAI_PORCELAIN_KIND_COMMAND;
      req->command_id = "yai.workspace.set";
      req->cmd_argc = argc - (cmdi + 2);
      req->cmd_argv = &argv[cmdi + 2];
      return 0;
    }
    if (strcmp(argv[cmdi + 1], "switch") == 0) {
      if (cmdi + 2 >= argc || !argv[cmdi + 2] || !argv[cmdi + 2][0]) {
        return set_err(req, "missing workspace id", "Run: yai ws switch <ws-id>");
      }
      req->kind = YAI_PORCELAIN_KIND_COMMAND;
      req->command_id = "yai.workspace.switch";
      req->cmd_argc = argc - (cmdi + 2);
      req->cmd_argv = &argv[cmdi + 2];
      return 0;
    }
    if (strcmp(argv[cmdi + 1], "current") == 0) {
      req->kind = YAI_PORCELAIN_KIND_COMMAND;
      req->command_id = "yai.workspace.current";
      req->cmd_argc = argc - (cmdi + 2);
      req->cmd_argv = &argv[cmdi + 2];
      return 0;
    }
    if (strcmp(argv[cmdi + 1], "status") == 0) {
      req->kind = YAI_PORCELAIN_KIND_COMMAND;
      req->command_id = "yai.workspace.status";
      req->cmd_argc = argc - (cmdi + 2);
      req->cmd_argv = &argv[cmdi + 2];
      return 0;
    }
    if (strcmp(argv[cmdi + 1], "inspect") == 0) {
      req->kind = YAI_PORCELAIN_KIND_COMMAND;
      req->command_id = "yai.workspace.inspect";
      req->cmd_argc = argc - (cmdi + 2);
      req->cmd_argv = &argv[cmdi + 2];
      return 0;
    }
    if (strcmp(argv[cmdi + 1], "unset") == 0) {
      req->kind = YAI_PORCELAIN_KIND_COMMAND;
      req->command_id = "yai.workspace.unset";
      req->cmd_argc = argc - (cmdi + 2);
      req->cmd_argv = &argv[cmdi + 2];
      return 0;
    }
    if (strcmp(argv[cmdi + 1], "clear") == 0) {
      req->kind = YAI_PORCELAIN_KIND_COMMAND;
      req->command_id = "yai.workspace.clear";
      req->cmd_argc = argc - (cmdi + 2);
      req->cmd_argv = &argv[cmdi + 2];
      return 0;
    }
    if (strcmp(argv[cmdi + 1], "domain") == 0) {
      ...
      if (strcmp(argv[cmdi + 2], "get") == 0) {
        req->kind = YAI_PORCELAIN_KIND_COMMAND;
        req->command_id = "yai.workspace.domain_get";
      ...
      if (strcmp(argv[cmdi + 2], "set") == 0) {
        req->kind = YAI_PORCELAIN_KIND_COMMAND;
        req->command_id = "yai.workspace.domain_set";
        req->cmd_argc = argc - (cmdi + 3);
        req->cmd_argv = &argv[cmdi + 3];
        return 0;
      }
    ...
    if (strcmp(argv[cmdi + 1], "policy") == 0) {
      if (cmdi + 2 < argc && argv[cmdi + 2] && strcmp(argv[cmdi + 2], "effective") == 0) {
        req->kind = YAI_PORCELAIN_KIND_COMMAND;
        req->command_id = "yai.workspace.policy_effective";
        req->cmd_argc = argc - (cmdi + 3);
        req->cmd_argv = &argv[cmdi + 3];
        return 0;
      }
      if (cmdi + 2 < argc && argv[cmdi + 2] && strcmp(argv[cmdi + 2], "dry-run") == 0) {
        ...
        req->kind = YAI_PORCELAIN_KIND_COMMAND;
        req->command_id = "yai.workspace.policy_dry_run";
        req->cmd_argc = argc - (cmdi + 3);
        req->cmd_argv = &argv[cmdi + 3];
        return 0;
      }
      if (cmdi + 2 < argc && argv[cmdi + 2] && strcmp(argv[cmdi + 2], "attach") == 0) {
        ...
        req->kind = YAI_PORCELAIN_KIND_COMMAND;
        req->command_id = "yai.workspace.policy_attach";
        req->cmd_argc = argc - (cmdi + 3);
        req->cmd_argv = &argv[cmdi + 3];
        return 0;
      }
      if (cmdi + 2 < argc && argv[cmdi + 2] && strcmp(argv[cmdi + 2], "activate") == 0) {
        ...
        req->kind = YAI_PORCELAIN_KIND_COMMAND;
        req->command_id = "yai.workspace.policy_activate";
        req->cmd_argc = argc - (cmdi + 3);
        req->cmd_argv = &argv[cmdi + 3];
        return 0;
      }
      if (cmdi + 2 < argc && argv[cmdi + 2] && strcmp(argv[cmdi + 2], "detach") == 0) {
        ...
        req->kind = YAI_PORCELAIN_KIND_COMMAND;
        req->command_id = "yai.workspace.policy_detach";
        req->cmd_argc = argc - (cmdi + 3);
        req->cmd_argv = &argv[cmdi + 3];
        return 0;
      }
    ...
    if (strcmp(argv[cmdi + 1], "run") == 0) {
      if (cmdi + 2 >= argc || !argv[cmdi + 2] || !argv[cmdi + 2][0]) {
        return set_err(req, "missing workspace run action", "Run: yai ws run <action> [context tokens]");
      }
      req->kind = YAI_PORCELAIN_KIND_COMMAND;
      req->command_id = "yai.workspace.run";
      req->cmd_argc = argc - (cmdi + 2);
      req->cmd_argv = &argv[cmdi + 2];
      return 0;
    }
    if (strcmp(argv[cmdi + 1], "debug") == 0) {
      if (cmdi + 2 < argc && argv[cmdi + 2] && strcmp(argv[cmdi + 2], "resolution") == 0) {
        req->kind = YAI_PORCELAIN_KIND_COMMAND;
        req->command_id = "yai.workspace.debug_resolution";
        req->cmd_argc = argc - (cmdi + 3);
        req->cmd_argv = &argv[cmdi + 3];
        return 0;
      }
    ...
    if (strcmp(argv[cmdi + 1], "graph") == 0) {
      if (cmdi + 2 >= argc || !argv[cmdi + 2]) {
        return set_err(req, "missing graph action", "Run: yai ws graph <summary|workspace|governance|decision|evidence|authority|artifact|lineage|recent>");
      }
      req->kind = YAI_PORCELAIN_KIND_COMMAND;
      if (strcmp(argv[cmdi + 2], "summary") == 0) req->command_id = "yai.workspace.graph.summary";
      else if (strcmp(argv[cmdi + 2], "workspace") == 0) req->command_id = "yai.workspace.graph.workspace";
      else if (strcmp(argv[cmdi + 2], "governance") == 0) req->command_id = "yai.workspace.graph.governance";
      else if (strcmp(argv[cmdi + 2], "decision") == 0) req->command_id = "yai.workspace.graph.decision";
      else if (strcmp(argv[cmdi + 2], "evidence") == 0) req->command_id = "yai.workspace.graph.evidence";
      else if (strcmp(argv[cmdi + 2], "authority") == 0) req->command_id = "yai.workspace.graph.authority";
      else if (strcmp(argv[cmdi + 2], "artifact") == 0) req->command_id = "yai.workspace.graph.artifact";
      else if (strcmp(argv[cmdi + 2], "lineage") == 0) req->command_id = "yai.workspace.graph.lineage";
      else if (strcmp(argv[cmdi + 2], "recent") == 0) req->command_id = "yai.workspace.graph.recent";
      else return set_err(req, "unknown graph action", "Run: yai ws graph <summary|workspace|governance|decision|evidence|authority|artifact|lineage|recent>");
      req->cmd_argc = argc - (cmdi + 3);
      req->cmd_argv = &argv[cmdi + 3];
      return 0;
    }
    if (strcmp(argv[cmdi + 1], "data") == 0) {
      ...
      if (strcmp(argv[cmdi + 2], "events") == 0) { family = "events"; command_id = "yai.workspace.data.events"; }
      else if (strcmp(argv[cmdi + 2], "evidence") == 0) { family = "evidence"; command_id = "yai.workspace.data.evidence"; }
      else if (strcmp(argv[cmdi + 2], "governance") == 0) { family = "governance"; command_id = "yai.workspace.data.governance"; }
      else if (strcmp(argv[cmdi + 2], "authority") == 0) { family = "authority"; command_id = "yai.workspace.data.authority"; }
      else if (strcmp(argv[cmdi + 2], "artifacts") == 0) { family = "artifact"; command_id = "yai.workspace.data.artifacts"; }
      else if (strcmp(argv[cmdi + 2], "enforcement") == 0) { family = "enforcement"; command_id = "yai.workspace.data.enforcement"; }
    ...
    if (strcmp(argv[cmdi + 1], "knowledge") == 0) {
      const char *family = NULL;
      const char *command_id = NULL;
      if (cmdi + 2 >= argc || !argv[cmdi + 2]) {
        return set_err(req, "missing knowledge action", "Run: yai ws knowledge <status|transient|memory|providers|context>");
      }
      ...
      if (strcmp(argv[cmdi + 2], "transient") == 0) { family = "transient"; command_id = "yai.workspace.knowledge.transient"; }
      else if (strcmp(argv[cmdi + 2], "memory") == 0) { family = "memory"; command_id = "yai.workspace.knowledge.memory"; }
      else if (strcmp(argv[cmdi + 2], "providers") == 0) { family = "providers"; command_id = "yai.workspace.knowledge.providers"; }
      else if (strcmp(argv[cmdi + 2], "context") == 0) { family = "context"; command_id = "yai.workspace.knowledge.context"; }
      else return set_err(req, "unknown knowledge action", "Run: yai ws knowledge <status|transient|memory|providers|context>");
      req->kind = YAI_PORCELAIN_KIND_COMMAND;
      req->command_id = command_id;
      req->cmd_argc = argc - (cmdi + 2);
      req->cmd_argv = &argv[cmdi + 2];
    ...
    if (strcmp(argv[cmdi + 1], "db") == 0) {
      ...
      if (strcmp(argv[cmdi + 2], "classes") == 0) {
        req->command_id = "yai.workspace.db.classes";
        req->cmd_argc = argc - (cmdi + 2);
        req->cmd_argv = &argv[cmdi + 2];
        req->cmd_argv[0] = "workspace";
        return 0;
      }
      if (strcmp(argv[cmdi + 2], "count") == 0) {
        req->command_id = "yai.workspace.db.count";
        req->cmd_argc = argc - (cmdi + 2);
        req->cmd_argv = &argv[cmdi + 2];
      ...
      if (strcmp(argv[cmdi + 2], "tail") == 0) {
        req->command_id = "yai.workspace.db.tail";
        req->cmd_argc = argc - (cmdi + 3);
        req->cmd_argv = &argv[cmdi + 3];
        return 0;
      }
    ...
    if (strcmp(argv[cmdi + 1], "recovery") == 0) {
      ...
      if (strcmp(argv[cmdi + 2], "load") == 0) {
        req->command_id = "yai.workspace.lifecycle.maintain";
        req->cmd_argc = argc - (cmdi + 3);
        req->cmd_argv = &argv[cmdi + 3];
        return 0;
      }
    ...
    if (strcmp(argv[cmdi + 1], "query") == 0) {
      ...
      req->kind = YAI_PORCELAIN_KIND_COMMAND;
      req->command_id = "yai.workspace.query";
      req->cmd_argc = argc - (cmdi + 2);
      req->cmd_argv = &argv[cmdi + 2];
      return 0;
    }
    if (strcmp(argv[cmdi + 1], "prompt-context") == 0 ||
      ...
      req->kind = YAI_PORCELAIN_KIND_COMMAND;
      req->command_id = "yai.workspace.prompt_context";
      req->cmd_argc = argc - (cmdi + 2);
      req->cmd_argv = &argv[cmdi + 2];
      return 0;
    }
    return set_err(req, "unknown workspace action", "Run: yai help ws");
  }

  /* Canonical source-plane operator topology:
     - yai source enroll <source-label> [--owner-ref ...] [--source-node-id ...] [--daemon-instance-id ...]
     - yai source attach <source-node-id> [--scope ...] [--constraints-ref ...] [--owner-workspace-id ...]
     - yai source list
     - yai source status
     - yai source inspect
  ...
  /* From here on, resolve commands via SDK catalog (CLI stays registry-agnostic). */
