...
- **L0 — Contracts**: canonical, normative contracts in `law` (canonical) and `embedded/law` (runtime contract surface)
...
- **Spec-first**: normative behavior is defined in `law`; implementation is never normative.
