...
#define YAI_LAW_CONTRIBUTOR_MAX 12
...
typedef struct yai_law_effective_stack {
  ...
  char regulatory_overlays[YAI_LAW_COMPLIANCE_MAX][64];
  int regulatory_overlay_count;
  char sector_overlays[YAI_LAW_COMPLIANCE_MAX][64];
  int sector_overlay_count;
  char contextual_overlays[YAI_LAW_COMPLIANCE_MAX][64];
  int contextual_overlay_count;
  char overlay_layers[YAI_LAW_COMPLIANCE_MAX][64];
  int overlay_count;
  char authority_contributors[YAI_LAW_CONTRIBUTOR_MAX][64];
  int authority_contributor_count;
  char evidence_contributors[YAI_LAW_CONTRIBUTOR_MAX][64];
